# Run pack: og-image, round 1, direction C
...
Direction: Direction C, "Framed page": a framed container with a 20 px radius, as the kit's documentation frames, glowing band on top, the title inside as if it were the page header; identical structure for landing and docs cards.
