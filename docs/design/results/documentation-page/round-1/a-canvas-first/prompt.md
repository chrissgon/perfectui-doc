# Run pack: documentation-page, round 1, direction A
...
Direction: Direction A, "Canvas first": every example block is a wide framed canvas with the landing's dot grid, the rendered component centred at a generous size, and the code drawer sliding under it; prose is narrow and sits above; the sidebar is light and nearly invisible.
