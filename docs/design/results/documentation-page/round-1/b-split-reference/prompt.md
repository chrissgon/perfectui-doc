# Run pack: documentation-page, round 1, direction B
...
Direction: Direction B, "Split reference": content and code live side by side on wide screens, prose and preview left and the code of the current example pinned right, following the scroll; on narrow screens it becomes tabs.
