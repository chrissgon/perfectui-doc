...
- Current flow: flow-fix-bug (draft, written alongside this task) on "the header menu (three dots) disappears above the header when the page scrolls" (user, 2026-09-26); phase 1 root cause confirmed (`docs/engineering/plans/header-menu-scroll.md`), waiting at its checkpoint
