---
title: Field Group
description: "Wraps a control with its label and its message. Both are real elements, so screen readers announce them, browsers translate them, and users can select the text."
tags: [form, field-group]
---
