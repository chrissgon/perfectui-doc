---
title: Radio
description: "A native `<input type=\"radio\">` with the `pui-radio` class. Grouping, arrow-key navigation and the one-of-many behavior all come from the `name` attribute."
tags: [form, radio]
---
