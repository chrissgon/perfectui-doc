---
title: List
description: "Styles `<ul>` and `<ol>` without touching either element globally: the class carries everything, including the reset of the browser's own indentation."
tags: [component, list]
---
