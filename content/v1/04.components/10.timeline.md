---
title: Timeline
description: "Events in order, with a rule connecting them. Each checkpoint draws its own segment, so a timeline is a sequence of checkpoints with nothing in between."
