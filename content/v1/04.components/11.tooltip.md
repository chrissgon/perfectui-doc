---
title: Tooltip
description: "Built on `interestfor` and `popover=\"hint\"`. It appears on hover, on keyboard focus, and on a long press — which is what makes it work on touch screens, unlike the old tooltip."
