...
description: "`1.0.0` is a rewrite. The SCSS build is gone, every class is prefixed, and the components that used to be driven by Perfect UI's JavaScript are now driven by the browser."
...
| `0.23.0`                              | `1.0.0`                                                 |
| ------------------------------------- | ------------------------------------------------------- |
| :v0{name="btn" to="components/button"}                                 | `pui-btn`                                               |
| :v0{name="badge" to="components/badge"}                               | `pui-badge`, plus the new `pui-chip`                    |
| :v0{name="card" to="components/card"}, `card-header`, `card-content` | `pui-card`, `pui-card-header`, `pui-card-content`       |
| :v0{name="list" to="components/list"}, `list-item`                   | `pui-list`, `pui-list-item`                             |
| :v0{name="table" to="components/table"}                               | `pui-table`                                             |
| :v0{name="timeline" to="components/timeline"}, `checkpoint`              | `pui-timeline`, `pui-checkpoint`, `pui-checkpoint-icon` |
| :v0{name="group-row" to="general/layout-group"}, `group-col`              | `pui-group-row`, `pui-group-col`                        |
| :v0{name="float" to="general/float"}                               | `pui-float`                                             |
| :v0{name="input" to="forms/input"}, `addon`, `input-group`       | `pui-input`, `pui-addon`, `pui-input-group`             |
| :v0{name="checkbox" to="forms/checkbox"}, `radio`, `switch`         | `pui-checkbox`, `pui-radio`, `pui-switch`               |
...
[Theme Color](/docs/v1/customization/theme-color).
...
| `table-bordered`, `table-borderless`, `table-responsive`                | Recipes in the [Table](/docs/v1/components/table) docs  |
| `list-bordered`, `unmarker`, `.active`                                  | Composition: `pui-outline pui-surface`, `list-style: none`, `pui-soft pui-theme`             |
| `float-right`, `float-top`                                              | One declaration, see [Float](/docs/v1/general/float) |
