  ...
  <MoleculeDocsSection>
    ...
    <MoleculeDocsContent>
      ...
      <OrganismTabs :tabs="['preview', 'code']">
        ...
        <template #preview>
          <MoleculeCodePreview :preview="CODE_VIEW_LIST_DISC" />
        </template>
        <template #code>
          <MoleculeCodeView :input="CODE_VIEW_LIST_DISC" />
        </template>
      </OrganismTabs>
      ...
      <OrganismTabs :tabs="['preview', 'code']">
        ...
        <template #preview>
          <MoleculeCodePreview :preview="CODE_VIEW_LIST_DECIMAL" />
        </template>
        <template #code>
          <MoleculeCodeView :input="CODE_VIEW_LIST_DECIMAL" />
        </template>
      </OrganismTabs>
      ...
      <OrganismTabs :tabs="['preview', 'code']">
        ...
        <template #preview>
          <MoleculeCodePreview :preview="CODE_VIEW_LIST_NONE" />
        </template>
        <template #code>
          <MoleculeCodeView :input="CODE_VIEW_LIST_NONE" />
        </template>
      </OrganismTabs>
    </MoleculeDocsContent>
    ...
    <MoleculeDocsContent>
      ...
      <OrganismTabs :tabs="['preview', 'code']">
        ...
        <template #preview>
          <MoleculeCodePreview :preview="CODE_VIEW_LIST_CUSTOM_MARKER" />
        </template>
        <template #code>
          <MoleculeCodeView :input="CODE_VIEW_LIST_CUSTOM_MARKER" />
        </template>
      </OrganismTabs>
    </MoleculeDocsContent>
    ...
    <MoleculeDocsContent>
      ...
      <OrganismTabs :tabs="['preview', 'code']">
        ...
        <template #preview>
          <MoleculeCodePreview :preview="CODE_VIEW_LIST_BORDERED" />
        </template>
        <template #code>
          <MoleculeCodeView :input="CODE_VIEW_LIST_BORDERED" />
        </template>
      </OrganismTabs>
    </MoleculeDocsContent>
    ...
    <MoleculeDocsContent>
      ...
      <p>
        ...
        <AtomToken>.list-hoverable</AtomToken> class.
      </p>
      ...
      <OrganismTabs :tabs="['preview', 'code']">
        ...
        <template #preview>
          <MoleculeCodePreview :preview="CODE_VIEW_LIST_HOVERABLE" />
        </template>
        <template #code>
          <MoleculeCodeView :input="CODE_VIEW_LIST_HOVERABLE" />
        </template>
      </OrganismTabs>
    </MoleculeDocsContent>
    ...
    <MoleculeDocsContent>
      ...
      <p>
        ...
        <AtomToken>.list-striped</AtomToken> class.
      </p>
      ...
      <OrganismTabs :tabs="['preview', 'code']">
        ...
        <template #preview>
          <MoleculeCodePreview :preview="CODE_VIEW_LIST_STRIPED" />
        </template>
        <template #code>
          <MoleculeCodeView :input="CODE_VIEW_LIST_STRIPED" />
        </template>
      </OrganismTabs>
    </MoleculeDocsContent>
    ...
    <MoleculeDocsContent>
      ...
      <OrganismTabs :tabs="['preview', 'code']">
        ...
        <template #preview>
          <MoleculeCodePreview :preview="CODE_VIEW_LIST_ICON" />
        </template>
        <template #code>
          <MoleculeCodeView :input="CODE_VIEW_LIST_ICON" />
        </template>
      </OrganismTabs>
    </MoleculeDocsContent>
    ...
    <MoleculeDocsContent>
      ...
      <OrganismTabs :tabs="['preview', 'code']">
        ...
        <template #preview>
          <MoleculeCodePreview :preview="CODE_VIEW_LIST_BADGE" />
        </template>
        <template #code>
          <MoleculeCodeView :input="CODE_VIEW_LIST_BADGE" />
        </template>
      </OrganismTabs>
    </MoleculeDocsContent>
    ...
    <MoleculeDocsContent>
      ...
      <OrganismTabs :tabs="['preview', 'code']">
        ...
        <template #preview>
          <MoleculeCodePreview :preview="CODE_VIEW_LIST_INVOICE" />
        </template>
        <template #code>
          <MoleculeCodeView :input="CODE_VIEW_LIST_INVOICE" />
        </template>
      </OrganismTabs>
    </MoleculeDocsContent>
  </MoleculeDocsSection>
...
`;
const CODE_VIEW_LIST_DECIMAL = `<ul class="list list-decimal">
  <li class="list-item">
    Now this is a story all about how, my life got flipped turned upside
    down
  </li>
...
`;
const CODE_VIEW_LIST_NONE = `<ul class="list">
  <li class="list-item">
    Now this is a story all about how, my life got flipped turned upside
    down
  </li>
...
const CODE_VIEW_LIST_BORDERED = `<ul class="sm:w-64 list list-bordered group-col bg-primary">
  <li class="list-item">
    Profile
  </li>
  <li class="list-item">
...
const CODE_VIEW_LIST_STATE = `<ul class="sm:w-64 list list-bordered group-col bg-primary">
...
const CODE_VIEW_LIST_HOVERABLE = `<ul class="sm:w-64 list list-bordered list-hoverable group-col bg-primary">
  <a class="list-item">
    <i class="bi-bell"></i>
    Newsletter
  </a>
...
const CODE_VIEW_LIST_STRIPED = `<ul class="sm:w-64 list list-bordered list-striped group-col bg-primary">
  <li class="list-item">
    Newsletter
  </li>
  <li class="list-item">
...
const CODE_VIEW_LIST_ICON = `<ul class="sm:w-64 list list-bordered group-col bg-primary">
  <li class="list-item">
    <i class="bi-bell"></i>
    Newsletter
  </li>
...
const CODE_VIEW_LIST_HORIZONTAL = `<ul class="w-fit list list-bordered list-hoverable group-row bg-primary">
  <a class="list-item">
    <i class="bi-bell"></i>
    Newsletter
  </a>
...
`;
const CODE_VIEW_LIST_BADGE = `<ul class="sm:w-64 list list-bordered list-hoverable group-col bg-primary">
  <a class="list-item">
    <span>
      <i class="bi-bell"></i>
      Profile
...
`;
const CODE_VIEW_LIST_INVOICE = `<ul class="sm:w-64 list list-bordered group-col bg-primary">
  <li class="list-item">
    <p>
      Payment to Front
